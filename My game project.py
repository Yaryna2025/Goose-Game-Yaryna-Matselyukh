...
def game_over_screen(score):
    ...
    text = font_large.render("Game Over!", True, COLOR_WHITE)
    score_text = FONT.render(f"Your Score: {score}", True, COLOR_WHITE)
    main_display.blit(text, (WIDTH//2 - text.get_width()//2, HEIGHT//2 - 50))
